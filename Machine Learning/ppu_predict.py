...
filePath = "dataset/pengetahuan_pemahaman_umum.csv"
predict_data = pd.read_csv(filePath)
update_dataset = predict_data.iloc[:,0:9].copy()

X_test = predict_data.iloc[:,7:9].values
...
# save dataset
update_dataset.to_csv('new dataset/pengetahuan_pemahaman_umum.csv', index=False)